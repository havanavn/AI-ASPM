  ...
  return (
    <SelectPrimitive.Item
      className={cn(
        ...
        // A disabled option stays VISIBLE and keeps its text. It is how the interface says a move
        // exists and why it cannot be taken; removing it would say nothing at all.
        "data-[disabled]:pointer-events-none data-[disabled]:opacity-60 data-[disabled]:italic",
        className,
      )}
      {...props}
    >
