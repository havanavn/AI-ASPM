        // ingestion [supporting] implementation — domain, application, infrastructure.
        dependencies {
            api(project(":module:ingestion-contract"))
...
implementation(project(":module:vulnerability-management-contract"))
implementation(project(":module:integration-contract"))
        }
