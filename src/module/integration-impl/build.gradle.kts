        // integration [generic] implementation — domain, application, infrastructure.
        dependencies {
            api(project(":module:integration-contract"))
...
// No permitted cross-module dependency. External connector surface.
        }
