        // capacity [supporting] implementation — domain, application, infrastructure.
        dependencies {
            api(project(":module:capacity-contract"))
...
implementation(project(":module:work-management-contract"))
